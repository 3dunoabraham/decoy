...
const Page: NextPageWithLayout = ({ tokens }:PageProps) => {
    ...
    return (<>
        <div className='flex-col tx-xl'>
        <Link href="/" className="opaci-chov--50">
                    <h1 className='tx-bold-8 opaci-50 tx-ls-5 tx-lgx pt-4  '
                        style={{color:"orangered",  borderBottom: "2px solid orangered"}}
                    >
                        Web POV
                    </h1>
                </Link>
            <h3>Byte Town</h3>
            <h1 className='_ddr px-4 tx-white'>WIP</h1>


            <div className=' flex-col'>
          <Link
            className='pa-2 opaci-chov--75 block pb-8 flex-col bg-glass-4 bg-b-10 mt-4   bord-r-50'
          ...
          >
            ...
            <h2 className='tx-lgx tx-shadow-5 translate-y-25' style={{ color: "orange" }}>
              <i className='tx-lx tx-altfont-4 tx-green tx-bold-2'>Play</i>
              {/* Town */}
            </h2>
          </Link>
        </div>
