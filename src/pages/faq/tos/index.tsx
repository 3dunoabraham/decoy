        ...
        >
          ...
          <a href={"/"} className="block flex-col">
                    ...
                    >
                        ...
                        <span className="tx-bold-6 opaci-chov--75 blurrotate-3 Q_md_x">TOS</span>
                        <div className="tx-bold-6 Q_sm flex-col translate-y--25">
                          ...
                          <span className="tx-bold-6 h-max-100px opaci-chov--75 blurrotate-3 opaci-50 ">TOS</span>
                        </div>
                        <small className="tx-bold-6 Q_xs flex-col ">
                          <span className="opaci-50 tx-bold-2 h-max-100px opaci-chov--75 ">FAQ:</span>
                          <span className="tx-bold-6 h-max-100px opaci-chov--75 blurrotate-3  ">TOS</span>
                        </small>
                    </h1>
                    </a>
