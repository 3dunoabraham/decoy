  ...
  const [velocityY, setVelocityY] = useState(0);
    ...
    <div className='h-min-500px w-100 flex-col g-b-20 bord-r- flex-align-stretch flex-justify-stretch pos-rel'>
        ...
        <div className="flex pos-abs bottom-0 right-0  bord-r- pa-2 ma-2">
            ...
            <div className="flex-col flex-align-stretch z-700 gap-1 tx-gray tx-shadow-b-1 tx-lg ">
                ...
                <div className="flex-col gap-1 opaci-50 tx-ls-">
                    ...
                    <input type="range" min="3" max="77" 
                        className="w-100 "
                        value={sizeForm.x} onChange={(e)=>{be_size(e.target.value,"x")}} 
                    />
                </div>
                {/* <div className="flex-col gap-1 opaci-50 tx-ls-">
                ...
                <div className="flex-col flex-align-stretch gap-2 rot-180">
                    ...
                    <div className="flex-center ">
                        <button onClick={()=>{toggleOption("frontwall")}}
                            style={{filter: "hue-rotate(-189deg) brightness(666%)", }}
                            className={` tx-center w-100   bord-r- px-2 pt-1 opaci-chov--50 tx-lx
                    ...
                    <div className="flex gap-1">
                        ...
                        <button onClick={()=>{toggleOption("rightwall")}} 
                            ...
                            `}
                        >
                            <div className="block" ><GiPayMoney /></div>
                        </button>
                    </div>
                    {/* <div className="flex-center">
        ...
        <Canvas shadows  onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} onMouseMove={handleMouseMove}
            ...
            camera={{ fov: fffooovvv }} 
        >
            <SemiOrbitCameraControl zPos={zOut}  />
            ...
            {optsToggler["floor"].bool && <FloorFloorScale  boundaries={[xOut, yOut, zOut]} position={[0,-yOut/2 - 0.05,0]} floorWidth={0.1}/>  }
            ...
            {optsToggler["backwall"].bool && <CustomWall length={zOut} width={xOut/2} roofHeight={yOut} position={[0, 0, -(zOut-(wallWidth*(1.5/2)))]}  thickness={wallWidth} color="#333333"  />}
            ...
            {optsToggler["frontwall"].bool && <CustomWall length={zOut} width={xOut/2} roofHeight={yOut} position={[0, 0, (zOut-(wallWidth*1.5))]}  thickness={wallWidth} color="#333333" />}
