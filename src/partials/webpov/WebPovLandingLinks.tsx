...
import { FaBookOpen, FaChartBar, FaCity, FaEnvelope, FaListAlt, FaStar, FaTwitter, FaUser, FaUserCircle } from "react-icons/fa"
import { BsBank2 } from "react-icons/bs"


export function WebPovLandingLinks({sessiondata}:any) {
    return (
        <div className='flex-wrap w-100 gap-2 '>
            ...
            >
                {/* <div><BsBank2 /></div> */}
                {/* <div>🏦</div> */}
                <div className=' tx-xl tx-shadow-5 tx-altfont-4'><small className="tx-l">Byte Town</small> </div>
            </Link>
            <Link href={"https://bytc.vercel.app/w"}      style={{background:"linear-gradient(-45deg, #F5D042, #FE59DA)"}}
                className={`px-3 py-2 flex-col bord-r-25 box-shadow-2-b over-4 clickble nowrap tx-lg 
                    opaci-chov--75 ${!sessiondata ? "" : "tx-white"}
                `}                
            >
                <div className="opaci-50"><FaCity /></div>
                <div className='tx-shadow-5 tx-altfont-4'>Byte City</div>
            </Link>
...
export default WebPovLandingLinks