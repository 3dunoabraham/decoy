    ...
    <div className=" flex-col flex-align-end pos-fix  bottom-0  right-0  " style={{}}>
        ...
        <div className=" flex-col flex-align-end pos-fix  top-0  right-0 z-200 " style={{}}>
            <details className="flex-1 w-100">
                <summary className="flex pa-2 opaci-chov--50 mb-2" >
                    <div className="flex-1"></div>
                    <button className="noclick tx-white pa-2 px-1 bord-r-50 tx-lg flex-center gap-2 tx-lgx px-2"
                        style={{background:"linear-gradient(0, #13A1FE, #059BFF)"}}>
                        <FaBars />
