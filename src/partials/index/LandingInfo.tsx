    ...
    return (
        <div>
            <div className="flex-col">
                <h1 className="tx-xxl">Welcome to Byte City:</h1>
            ...
            <div className="w-100 flex-col pb-100 pt-8 ">
                <div className="w-max-500px tx-l">
                    Byte City is an innovative platform that combines the worlds of learning and investing into an intuitive 3D Browser interface.
            ...
            <div className="w-max-600px tx-lg">
                Byte City is the ideal platform for individuals who want to invest but lack the time or expertise to actively manage their portfolios. Our platform automates the investment process, reduces risks, and maximizes profits, all while providing a user-friendly 3D Browser interface that makes investing a breeze.
            </div>
            ...
            <div className="mt-200">
                <div className="flex-wrap flex-justify-center gap-6 ">
                    ...
                    <div className=" w-max-300px">
                        ...
                        Byte City seamlessly integrates with other tools and systems. Discover how easy it is to connect Byte City with your preferred tools and enhance your investment experience.

                        Learn About Integration
                    </div>
                </div>
            </div>
            <div className=" py-100 my-100 flex-col flex-align-end">
                <div className="w-max-600px my-100">
                    <div className="flex-col flex-align-end">
                        <h3>Dive Into Investment Strategies:</h3>
                        <p className="tx-end w-max-500px">Understand the concepts behind Dollar Cost Averaging (DCA) and Automated Trading Systems (ATS). Explore how these strategies can benefit your investment journey and enhance your trading approach.</p>
                    </div>
                    <div className="flex-col flex-align-end my-100">
                        <h3>Learn About DCA | Learn About ATS</h3>

                        <p className="tx-end w-max-500px">Explore the Ecosystem:</p>
                        <p className="tx-end w-max-500px">Discover the different market sectors, protocols, and tokens that form the foundation of Byte City. Gain insights into the core, utility, and side-chain tokens that power our platform.</p>
                    </div>
                    <div className="flex-col flex-align-end">
